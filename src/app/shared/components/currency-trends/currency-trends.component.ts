...
export class CurrencyTrendsComponent implements OnInit {
  ...
  constructor() {
    ...
    this.values = [0.0113403757, 0.0114006886, 0.0117741252, 0.0128303, 0.0121577591, 0.0120694962, 0.012670979, 0.0126312067, 0.0127462415, 0.0127532313, 0.0126127262, 0.0118891927]
    this.lineChartData = [
